...
# Generated by Django 3.2.20 on 2023-08-18 17:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(verbose_name='Reminder Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receipt_image', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='fridge_app.photo')),
                ('item_list', models.TextField(max_length=1000)),
        ...
        migrations.AddField(
            model_name='photo',
            name='receipt_image',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fridge_app.receipt'),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('B', 'Bakery 🍞'), ('D', 'Dairy 🥛'), ('E', 'Eggs 🐔'), ('M', 'Meat and Seafood 🍖'), ('P', 'Produce \U0001f966'), ('O', 'Other 🍕')], max_length=1)),
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=8, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Total')),
                ('expiration', models.DateField(verbose_name='Expiration Date')),
                ('receipt', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='fridge_app.receipt')),
                ('reminders', models.ManyToManyField(to='fridge_app.Reminder')),
