# Generated by Django 3.2.20 on 2023-08-21 17:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receipt_image', models.ImageField(blank=True, upload_to='', verbose_name='Image')),
                ('item_list', models.TextField(max_length=1000)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('reciept_image', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='fridge_app.photo')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
