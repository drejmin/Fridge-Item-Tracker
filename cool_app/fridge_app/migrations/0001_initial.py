# Generated by Django 4.2.4 on 2023-08-18 00:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receipt_image', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='fridge_app.photo')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
